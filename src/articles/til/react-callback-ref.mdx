...
description: Stop using useEffect to get accessed to refs. Use callback refs!
date: 2023-07-24
category: React
---

# Stop trying to interact with refs in useEffect
...
Since React uses referential stability to check if the callback ref should run or not, it will skip if the same ref was passed in.
