...
Indeed it did change the protocol to use HTTP 🎉

Now that I can commit and push my changes to the repository, it will ask for my username and password.
Note that the support for password authentication was removed on August 13, 2021. Can no longer use my own password, but I need to use the generated personal access tokens.
