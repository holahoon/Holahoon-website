...
# Use callback refs instead of useEffect

## Purpose of this post

I wanted to make a navigation with an underline and animate it whenever the user is on a specific page. But, I didn't just want to make a boring underline and slide it from left of the navigation item to the right.
...
Thanks to TkDodo's [avoiding useEffect with callback refs](https://tkdodo.eu/blog/avoiding-use-effect-with-callback-refs) blog where I larned a ton from!
